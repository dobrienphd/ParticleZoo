...
PYBIND11_MODULE(_pz, m) {
    ...
    py::class_<Particle>(m, "Particle", 
        ...
        // PDG code
        .def("get_pdg_code", &Particle::getPDGCode,
             "Get the PDG identification code of the particle.")
        // Primary particle / generation methods
        .def_property("is_primary", &Particle::isPrimary, 
             [](Particle &p, bool primary){ p.setGeneration(primary ? 1 : 2); },
             "Whether this particle is a primary particle (not generated by another particle)")
        .def("set_generation", &Particle::setGeneration, py::arg("generation"),
             "Set the generation of the particle (1 for primary, 2+ for secondary).")
        // String property methods
        .def("set_string_property", &Particle::setStringProperty, py::arg("value"),
             "Add a custom string property to the particle.")
        // Property count methods
        .def("get_number_of_bool_properties", &Particle::getNumberOfBoolProperties,
             "Get the number of boolean properties currently stored.")
        .def("get_number_of_float_properties", &Particle::getNumberOfFloatProperties,
             "Get the number of float properties currently stored.")
        .def("get_number_of_int_properties", &Particle::getNumberOfIntProperties,
             "Get the number of integer properties currently stored.")
        // Reserve property methods
        .def("reserve_bool_properties", &Particle::reserveBoolProperties, py::arg("size"),
             "Reserve memory for boolean properties.")
        .def("reserve_float_properties", &Particle::reserveFloatProperties, py::arg("size"),
             "Reserve memory for float properties.")
        .def("reserve_int_properties", &Particle::reserveIntProperties, py::arg("size"),
             "Reserve memory for integer properties.")
        // Custom property getters
        .def("get_custom_bool_properties", &Particle::getCustomBoolProperties,
             "Get a list of all custom boolean properties.")
        .def("get_custom_float_properties", &Particle::getCustomFloatProperties,
             "Get a list of all custom float properties.")
        .def("get_custom_int_properties", &Particle::getCustomIntProperties,
             "Get a list of all custom integer properties.")
        .def("get_custom_string_properties", &Particle::getCustomStringProperties,
             "Get a list of all custom string properties.")
        ;
